...
if (usePairingCode && !conn.authState.creds.registered) {
  ...
  let phoneNumber = argv.number || ''
  while (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
    phoneNumber = await question(chalk.blueBright('Input nomor WhatsApp yang valid (awali dengan kode negara, contoh: 62812xxxxxx):\n'))
    phoneNumber = phoneNumber.replace(/\D/g, '') // Hapus simbol selain angka
  }
